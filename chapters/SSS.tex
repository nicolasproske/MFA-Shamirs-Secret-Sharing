...
Secret Sharing ist ein grundlegender Baustein der modernen Kryptographie. Eines der bekanntesten Verfahren wurde am 1. November 1979 veröffentlicht und ist nach seinem Erfinder Adi Shamir, einem israelischen Kryptographen, benannt: Shamir's Secret Sharing \autocite{shamir-secretsharing-1979}.\par
...
Die Konstante $b$ entspricht dabei dem Geheimnis $S$. Aus Gründen der Übersichtlichkeit wird in diesem Beispiel $m = 4$ als zufälliger Koeffizient gewählt:
...
Jeder der berechneten Punkte $(1, 3), (2, 7), (3, 11)$ repräsentiert dabei einen Share. \autoref{tab:shares} zeigt die Verteilung aller drei Shares an insgesamt drei unterschiedliche Nutzer:
...
Unter Verwendung dieser Formel lässt sich $m_0 = f(0)$ und damit das Geheimnis $S$ aus $k$ gegebenen Punkten berechnen \autocite[S. 65 f.]{bsi-richtlinie-2023}.
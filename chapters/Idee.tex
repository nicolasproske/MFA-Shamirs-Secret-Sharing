...
\node [data, fill=gray!20] at (0,-1) (input_factors) {Nutzer legt drei Faktoren fest};
\node [process, fill=gray!20] at (0,-2) (transform_factors) {Faktoren in Geheimnis umwandeln};
\node [process, fill=gray!20] at (0,-3) (gen_shares) {Geheimnis in Shares aufteilen};
\node [process, fill=gray!20] at (0,-4) (store_shares) {Shares verteilt speichern};
...
\node [data, fill=gray!20] at (0,-1) (def_factors) {Nutzer wählt zwei Faktoren aus};
\node [data, fill=gray!20] at (0,-2) (input_factors) {Nutzer gibt Faktoren ein};
\node [process, fill=gray!20] at (0,-3) (recon_shares) {Geheimnis rekonstruieren};
\node [decision, fill=gray!20] at (0,-5) (correct) {Korrekt?};

\node[draw=none] at (1.625, -4.75) (no) {Nein};
\node[draw=none] at (0.35, -6.25) (yes) {Ja};

\node [process, fill=red!20] at (3,-5) (error) {Fehler};
\node [process, fill=green!20] at (0,-7) (success) {Authentifiziert};
